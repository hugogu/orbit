          ...
          >
            ...
            <TabsContent value="model" className="help-tab-panel">
              <div className="model-explainer">
                ...
                <p>
                  {t(
                    '沙盘模式离开历表，改用牛顿万有引力对质点做速度 Verlet 积分：太阳、八大行星与冥王星共 10 个天体，地球以地月质心参与计算，不含卫星、彗星与小行星。积分步长按当前最紧密的一对天体自动选取，能量误差有界并实时显示。未计入广义相对论效应；不加改动运行一年，各天体与真实历表的差距约在 10⁻³ AU 以内，属于模型差异而非积分误差。这是用于理解引力的实验装置，不是预测工具。',
                  )}
                </p>
                <p>
                  {t(
